  ...
  return (
    <header className="sticky top-0 z-40 border-b-[3px] border-pop-night bg-pop-cream">
      <div className="mx-auto flex h-16 max-w-6xl items-center gap-6 px-4 sm:px-6">
        <Link href="/" className="flex items-center gap-2 font-display text-lg uppercase text-pop-night">
          ...
          {user ? (
            <>
              ...
              <form action="/auth/signout" method="post">
                <button
                  type="submit"
                  className="rounded-full border-[3px] border-pop-night bg-white px-4 py-2 font-display text-xs uppercase tracking-wide text-pop-night shadow-pop-sm transition-all hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none"
                >
                  Sign out
                </button>
              </form>
            ...
            <>
              <Link
                href="/login"
                className="hidden rounded-full border-[3px] border-pop-night bg-white px-4 py-2 font-display text-xs uppercase tracking-wide text-pop-night shadow-pop-sm transition-all hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none sm:inline-flex"
              >
                Sign in
              </Link>
              <Link
                href="/login"
                className="inline-flex items-center rounded-full border-[3px] border-pop-night bg-pop-yellow px-4 py-2 font-display text-xs uppercase tracking-wide text-pop-night shadow-pop-sm transition-all hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none"
              >
                Start free
              </Link>
            </>
